...
def set_data_into_job_actual_costing_from_pi(doc, method):
    ...
    try:
        ...
        frappe.log_error("Error: While set data in job after pi submit.", e, "Purchse Invoice", doc.name)
...
def set_expense_account(doc, method):
    ...
    try:
        ...
        frappe.log_error("Error: While set expense account in pi.", e, "Purchase Invoice", doc.name)